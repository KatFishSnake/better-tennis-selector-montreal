...
export const COURT_NOTES: Record<number, string> = {
  ...
  1734:
    "14 outdoor courts along avenue Émile-Duployé in the Plateau — 7 slow synthetic-carpet + 7 fast acrylic. Lit, open 8 AM–11 PM. Largest concentration of public courts in central Montreal.",

  // Parc Jeanne-Mance — Plateau-Mont-Royal
  1726:
    "Outdoor courts at the foot of Mount Royal (avenue de l'Esplanade × Mont-Royal). Generally busy on summer evenings — book early.",

  // Complexe sportif Claude-Robillard — Ahuntsic-Cartierville
  813:
    "4 indoor courts at the Ville de Montréal sports complex built for the 1976 Olympics. The main public indoor option in the city, open year-round.",

  // Terrains extérieurs Claude-Robillard
  866:
    "10 outdoor courts at the Claude-Robillard complex in Ahuntsic-Cartierville. Summer only; the outdoor companion to the indoor facility.",

  // Terrains de tennis Saint-Viateur (6) — Outremont
  654:
    "6 outdoor courts in Outremont near avenue Saint-Viateur. Well-maintained and popular with locals.",
  ...
  882:
    "Dedicated tennis facility in Saint-Laurent borough. Indoor option for year-round play.",

  // Centre Pierre-Charbonneau — Mercier–Hochelaga-Maisonneuve
  1628:
    "Multi-sport indoor complex near Olympic Park (3000 rue Viau). Hosts a range of activities; tennis bookings via loisirs.",
