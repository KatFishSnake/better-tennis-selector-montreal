      ...
      <Card className="shadow-none">
        <CardContent className="p-8 text-center">
          ...
          {state.kind === "authExpired" && (
            <>
              <p className="text-lg font-semibold mb-2">Your Loisirs session expired</p>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Loisirs Montréal signed you out. Sign in again, then click the Tennis MTL
                bookmarklet from your bookmarks bar.
              </p>
